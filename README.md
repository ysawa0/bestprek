...
3. Commit and push the changes to a branch, then open a pull request into `main`. Merge it after the required `check` job passes; reviewer approval is not required.
