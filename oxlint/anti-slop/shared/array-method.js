...
export function resolveArrayBinding(sourceCode, node) {
...
export function arrayMethodTarget(node) {
  node = unwrapArrayExpression(node);
...
export function isKnownArrayExpression(sourceCode, node, visited = new Set()) {
  node = unwrapArrayExpression(node);
